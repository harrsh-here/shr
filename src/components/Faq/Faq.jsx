...
const questions = [
  ...
  },
  {
    ...
    answer: "Students with a valid college ID are welcome to participate. Every member must carry their physical college ID card or a government ID (such as Aadhaar) for verification on the day of the event. Team requirements for each event are listed in its event details."
  },
  {
  ...
  },
  {
    ...
    answer: "Every team member must carry a physical photo ID — your original college ID card, or a government ID such as Aadhaar, Driving Licence or Passport. Digital copies and photographs are not accepted. IDs are checked at the reporting desk, and members without one may not be allowed to participate."
  },
  {
