...
function onEdit(e) {
  ...
  if (newStatus === "Verified") {
    ...
    body = [
      ...
      "Every team member must bring their college ID card or a government ID (Aadhaar, Driving Licence, Passport, etc.). IDs are checked at the reporting desk, and members without one may not be allowed to participate.",
      "",
